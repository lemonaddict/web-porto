...
<html lang="en">
    <head>
        ...
        <title>Muhammad Rafie Kurnia Portfolio</title>
        ...
        <style>
        /* CSS untuk membuat area komentar scrollable */
        .comment-container {
        max-height: 300px; /* Atur tinggi maksimal sesuai kebutuhan */
        overflow-y: auto; /* Aktifkan scroll jika konten melebihi tinggi maksimal */
        }
        </style>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="#" class="navbar-brand mx-auto mx-lg-0">Rafie</a>
        ...
        <main>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="images/foto-diri.png" class="avatar-image avatar-image-large img-fluid" alt="">

                                    <h1 class="hero-title ms-3 mb-0">Hai!</h1>
                                </div>

                                <h2 class="mb-4">My name is Muhammad Rafie Kurnia!</h2>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/kali.png" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    ...
                                    <img src="images/foto-diri.png" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">a little bit about me</h3>
                                <p>19 years old student, majoring in Computer Science. Have a high passion about anything related to computer or science in general. Keen to be a Cyber Security Engineer. </p>
                            </div>
                        </div>
                            ...
                            <div class="profile-thumb">
                                ...
                                <div class="profile-body">
                                    <p>
                                        ...
                                        <span>Muhammad Rafie Kurnia</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Birthday</span> 
                                        <span>Januari 2005</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:lmncat3@gmail.com">lmncat3@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="about-thumb">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-6 featured-border-start featured-border-bottom ps-5 py-2">
                                        ...
                                        <p class="featured-text">Bugs found</p>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-6 featured-border-start ps-5 pt-4">
                                        ...
                                        <p class="featured-text">Digital Awards / certificate</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row pt-lg-5">
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        ...
                                        <p>For your school, business, organization, etc.</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb services-thumb-up">
                                        ...
                                        <p>For your engaging social media post!</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        ...
                                        <p>If you need to secure your website, feel free to contact me.</p>

                                        <a href="#" class="custom-btn custom-border-btn btn mt-3">Discover More</a>

                                        <div class="services-icon-wrap d-flex justify-content-center align-items-center">
                                            <i class="services-icon bi-bug"></i>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">Augmented Reality</small>

                                    <h3 class="projects-title">Animal Rampage</h3>
                                </div>

                                <a href="images/projects/AR.jpg" class="popup-image">
                                    <img src="images/projects/AR.jpg" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">Pentesting</small>

                                    <h3 class="projects-title">Kali linux</h3>
                                </div>

                                <a href="images/projects/sqlmap.png" class="popup-image">
                                    <img src="images/projects/sqlmap.png" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">Copy Writing</a></li>

                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">Pentesting</a></li>
                                    ...
                                    <ul class="social-icon">
                                        <li class="social-icon-item"><a href="https://instagram.com/rapikur.19" class="social-icon-link bi-instagram"></a></li>

                                        <li class="social-icon-item"><a href="https://www.youtube.com/channel/UCWg2QDMsZjf22wrSZYuOybQ" class="social-icon-link bi-youtube"></a></li>
                                    </ul>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p class="mb-2">
                                        Rafie is a passionate student. Feel free to get in touch with me.
                              </p>

                                    <strong class="site-footer-title d-block mt-4 mb-3">Email</strong>

                                    <p>
                                        <a href="mailto:lmncat3@gmail.com">
                                            lmncat3@gmail.com
                                        </a>
                                    </p>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox2">
                                                    ...
                                                    <span class="form-check-label-text">Copy Writing</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox3">
                                                    <i class="bi-bug form-check-icon"></i>
                                                    <span class="form-check-label-text">Pentesting</span>
                                                </label>
                                            </div>
                                        </div>
            ...
            <section class="comment section-padding" id="section_6">
            <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="comment-container mb-4">
                    <!-- Konten komentar akan ditambahkan di sini -->
                    @if (!empty($comments))
            ...
            <div class="col-md-4">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="comment" class="form-control" placeholder="Leave a comment">
                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="copyright-text-wrap">
                            <p class="mb-0">
                                <span class="copyright-text"><a href="#"> Project Portfolio</a> </span>
                            </p>
                        </div>
                    </div>
